...
/**
 * check_elf - Determine ELF file
 * @e_ident: Pointer to ELF magic identity
 * Description: Exit with 98 if file is not ELF
 */
 ...
 * @e_ident: Pointer to ELF magic number
 * Description: Separate magic number by spaces
 */
...
/**
 * print_version - Prints header version
...
/**
 * main - Display content of ELF file
 * @argc: Argument count
 * @argv: Argument vector
 * Return: Always 0
 * Description: Exit code 98 if file is not an ELF file or function
 */
